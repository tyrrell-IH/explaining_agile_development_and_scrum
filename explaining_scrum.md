...
スプリントは後述する他の4つのイベントの入れ物のような性質を持ちます。
...
しかし、スクラム開発ではルールで定義されていない事柄も多く、ルールで定義されていない場合にはチーム内で話し合い、過去の経験も踏まえてやり方を決めていくことになります。

全てのやり方の指針になるのが確約、集中、公開、尊敬、勇気という5つの価値基準になるので、この価値基準を念頭に置いてスクラム開発に取り組みましょう。
