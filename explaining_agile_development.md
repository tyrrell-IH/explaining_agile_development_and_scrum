...
その従来のやり方と異なる開発手法を実践していた17名のソフトウェア開発者が、その主義や主張について議論を行った結果を
- 4つの価値
- その価値に由来する12の原則

として取りまとめたものを公開しました。

4つの価値のことを「アジャイルソフトウェア開発宣言」と呼び、12の原則のことを「アジャイル宣言の背後にある原則」と呼びます。
...
開発の途中でも顧客の要求の本質を見抜き、与えられたコストや納期も考慮した上で、積極的に要求の変更を受け入れることが顧客にとって価値のあるソフトウェアを作ることにつながります。
